 ...
 *********************************************************************************/
/*
 * NAME:     initSRU.c (Block-based Talk-through)
 * PURPOSE:  Talk-through framework for sending and receiving audio samples on the
 *            21469 EZ-KIT Lite AD1939 Codec using SPORTs 0/1
...
/*-----------------------------------------------------------------------------
 ...
 AD1939                   :SHARC ADSP-21469    
   ...
   OUT                    :  o-PBEN07_I=LOW      |   |  +----o-SPORT0_DA_O
                          :                      |   |  | +--o-SPORT0_DB_O
   ADC   192 kHz   DAI_P08:  o-DAI_PB08_O--------*   |  | |
   FS   >---------------->#--o-                  |   |  | |
   OUT                    :  o-PBEN08_I=LOW      |   |  | |
                          :                      |   |  | | 
...
/* The following definition allows the SRU macro to check for errors.
 * Once the routings have been verified, this definition can be removed to
 * save some program memory space.The preprocessor will issue a warning stating
 * this when using the SRU macro without this definition.
 */
